...
def display_ec2_instances(instances):
    """Display the filtered EC2 instances in a structured format."""
    if not instances:
    ...
    for instance in instances:
        print(json.dumps(instance, indent=4))  # Pretty-print the instance details

if __name__ == '__main__':
    """Main function to execute the application."""
    file_path = 'ec2_instances.json'  # Specify the path to your JSON file
