...
def filter_instances(instances, min_vcpu, max_vcpu, min_memory, max_memory): #  Filter the EC2 instances based on user requirements."""
...
if __name__ == '__main__':
    ...
    file_path = 'ec2_instance_types.json'  # Specify the path to your JSON file
